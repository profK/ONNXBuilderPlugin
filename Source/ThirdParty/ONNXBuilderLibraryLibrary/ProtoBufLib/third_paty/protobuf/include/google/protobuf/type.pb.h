...
class Type final :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::protobuf::Field >*
      mutable_fields();
  private:
  const ::google::protobuf::Field& _internal_fields(int index) const;
  ::google::protobuf::Field* _internal_add_fields();
  public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::protobuf::Option >*
      mutable_options();
  private:
  const ::google::protobuf::Option& _internal_options(int index) const;
  ::google::protobuf::Option* _internal_add_options();
  public:
...
class Enum final :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::protobuf::EnumValue >*
      mutable_enumvalue();
  private:
  const ::google::protobuf::EnumValue& _internal_enumvalue(int index) const;
  ::google::protobuf::EnumValue* _internal_add_enumvalue();
  public:
...
inline const ::google::protobuf::Field& Type::_internal_fields(int index) const {
...
inline ::google::protobuf::Field* Type::_internal_add_fields() {
  return _impl_.fields_.Add();
}
inline ::google::protobuf::Field* Type::add_fields() {
  ::google::protobuf::Field* _add = _internal_add_fields();
...
inline const ::google::protobuf::Option& Type::_internal_options(int index) const {
...
inline ::google::protobuf::Option* Type::_internal_add_options() {
  return _impl_.options_.Add();
}
inline ::google::protobuf::Option* Type::add_options() {
  ::google::protobuf::Option* _add = _internal_add_options();
...
inline const ::google::protobuf::Option& Field::_internal_options(int index) const {
  return _impl_.options_.Get(index);
}
...
inline ::google::protobuf::Option* Field::_internal_add_options() {
  return _impl_.options_.Add();
}
...
inline const ::google::protobuf::EnumValue& Enum::_internal_enumvalue(int index) const {
...
inline ::google::protobuf::EnumValue* Enum::_internal_add_enumvalue() {
  return _impl_.enumvalue_.Add();
}
inline ::google::protobuf::EnumValue* Enum::add_enumvalue() {
  ::google::protobuf::EnumValue* _add = _internal_add_enumvalue();
...
inline const ::google::protobuf::Option& Enum::_internal_options(int index) const {
  return _impl_.options_.Get(index);
}
...
inline ::google::protobuf::Option* Enum::_internal_add_options() {
  return _impl_.options_.Add();
}
...
inline const ::google::protobuf::Option& EnumValue::_internal_options(int index) const {
  return _impl_.options_.Get(index);
}
...
inline ::google::protobuf::Option* EnumValue::_internal_add_options() {
  return _impl_.options_.Add();
}
