...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 8, -1, sizeof(::google::protobuf::Struct_FieldsEntry_DoNotUse)},
  { 10, -1, -1, sizeof(::google::protobuf::Struct)},
  { 17, -1, -1, sizeof(::google::protobuf::Value)},
  { 30, -1, -1, sizeof(::google::protobuf::ListValue)},
};
...
const ::_pbi::DescriptorTable descriptor_table_struct_2eproto = {
    false, false, 622, descriptor_table_protodef_struct_2eproto,
    "struct.proto",
...
uint8_t* Struct::_InternalSerialize(
  ...
  if (!this->_internal_fields().empty()) {
    using MapType = ::_pb::Map<std::string, ::google::protobuf::Value>;
