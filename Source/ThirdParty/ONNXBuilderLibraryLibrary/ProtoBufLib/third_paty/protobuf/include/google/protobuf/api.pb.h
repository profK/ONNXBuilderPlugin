...
class Api final :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::protobuf::Method >*
      mutable_methods();
  private:
  const ::google::protobuf::Method& _internal_methods(int index) const;
  ::google::protobuf::Method* _internal_add_methods();
  public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::protobuf::Mixin >*
      mutable_mixins();
  private:
  const ::google::protobuf::Mixin& _internal_mixins(int index) const;
  ::google::protobuf::Mixin* _internal_add_mixins();
  public:
...
inline const ::google::protobuf::Method& Api::_internal_methods(int index) const {
...
inline ::google::protobuf::Method* Api::_internal_add_methods() {
  return _impl_.methods_.Add();
}
inline ::google::protobuf::Method* Api::add_methods() {
  ::google::protobuf::Method* _add = _internal_add_methods();
...
inline const ::google::protobuf::Mixin& Api::_internal_mixins(int index) const {
...
inline ::google::protobuf::Mixin* Api::_internal_add_mixins() {
  return _impl_.mixins_.Add();
}
inline ::google::protobuf::Mixin* Api::add_mixins() {
  ::google::protobuf::Mixin* _add = _internal_add_mixins();
