...
static ::_pb::Metadata file_level_metadata_source_5fcontext_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_source_5fcontext_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_source_5fcontext_2eproto = nullptr;

const uint32_t TableStruct_source_5fcontext_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_source_5fcontext_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\"\n\rSourceContext\022\021\n\tfile_name\030\001 \001(\tB\212\001\n\023"
  "com.google.protobufB\022SourceContextProtoP"
  "\001Z6google.golang.org/protobuf/types/know"
  "n/sourcecontextpb\242\002\003GPB\252\002\036Google.Protobu"
  "f.WellKnownTypesb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_source_5fcontext_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_source_5fcontext_2eproto = {
    false, false, 224, descriptor_table_protodef_source_5fcontext_2eproto,
    "source_context.proto",
    &descriptor_table_source_5fcontext_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_source_5fcontext_2eproto::offsets,
    file_level_metadata_source_5fcontext_2eproto, file_level_enum_descriptors_source_5fcontext_2eproto,
    file_level_service_descriptors_source_5fcontext_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_source_5fcontext_2eproto_getter() {
  return &descriptor_table_source_5fcontext_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_source_5fcontext_2eproto(&descriptor_table_source_5fcontext_2eproto);
namespace google {
namespace protobuf {
...
::PROTOBUF_NAMESPACE_ID::Metadata SourceContext::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_source_5fcontext_2eproto_getter, &descriptor_table_source_5fcontext_2eproto_once,
      file_level_metadata_source_5fcontext_2eproto[0]);
}
